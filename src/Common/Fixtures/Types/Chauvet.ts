import { FixtureDescriptor, FixtureModeMap, FixtureModes } from 'Common/Fixtures/Types';
...
export class ChauvetQ6 implements FixtureDescriptor {
    ...
    public readonly components: FixtureModeMap = { '4-Channel': [ 'RGB', 'A' ] };
}
...
export class ChauvetQUV12 implements FixtureDescriptor {
    ...
    public readonly components: FixtureModeMap = { '6-Channel': [ 'RGB', 'A', 'W', 'UV' ]};
}
